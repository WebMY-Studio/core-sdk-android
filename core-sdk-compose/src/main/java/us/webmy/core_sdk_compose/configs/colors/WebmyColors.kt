package us.webmy.core_sdk_compose.configs.colors
...
internal val LocalWebmyColors = staticCompositionLocalOf<WebmyColorsPalette> {
    noLocalProvidedFor("WebmyColorsPalette")
}

object WebmyStableColors {
